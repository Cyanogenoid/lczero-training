...
protoc --proto_path=libs/lczero-common --cpp_out=pytorch/dataloader libs/lczero-common/proto/net.proto
protoc --proto_path=libs/lczero-common --cpp_out=pytorch/dataloader libs/lczero-common/proto/chunk.proto
